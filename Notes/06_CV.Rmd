...
3. Modify the KDE approach:
    ...
    \[
    MISE(\widehat{f}_h) = \underbrace{\E \int \big( \widehat{f}_h(x) - f(x) \big)^2 d x}_{\E \| \widehat{f}_h - f \|_2^2} =     \underbrace{\E \int \big[ \widehat{f}_h(x) \big]^2 d x}_{\E \| \widehat{f}_h\|_2^2} - 2 \underbrace{\E \int \widehat{f}_h(x)     f(x) d x}_{\E \langle \widehat{f}_h, f \rangle} + \underbrace{\int \big[ f(x) \big]^2}_{\| f \|_2^2} d x.
    \]
