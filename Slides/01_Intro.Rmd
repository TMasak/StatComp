...
Go to [Supplement 02](../Manuals/02_Github.html) and set up R, RStudio and GitHub for yourself as described there.

Make your first submission (submit whatever you want) as described in the [course requirements](../Manuals/01_Organization.html). [5 %]
